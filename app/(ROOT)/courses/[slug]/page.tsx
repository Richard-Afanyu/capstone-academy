...
const EnrollPage = async ({
  ...
  if (!actual) {
    return (
      <div>
        <h2>Sorry! this course does not exist</h2>
  ...
  return (
    <div className="mt-[20px] gap-[40px] grid grid-cols-1 md:grid-cols-5 xl:grid-cols-7">
      ...
      <div className="md:col-span-3 xl:col-span-4">
        {/* left top */}
        <div>
          <YouTubePlayer videoId={actual.video} />{" "}
        </div>
      ...
      <div className="md:col-span-2 xl:col-span-3">
        ...
        <div className="mt-[20px]">
          <QuestionSection courseId={actual._id} />
        </div>

        {/* finished section */}
        <div className="flex flex-col gap-4 mt-[40px]">
          <h2 className="text-muted-foreground">
            All done. Feel free to re-visite this course if you run into any
            problems.
          </h2>
        </div>
